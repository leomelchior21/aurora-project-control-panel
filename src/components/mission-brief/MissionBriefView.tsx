  ...
  return (
    <div className="grid gap-4">
      <section className="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
        ...
        <div className="grid gap-4">
          <div className="aurora-panel rounded-[30px] border border-white/10 p-6">
            <p className="text-[10px] uppercase tracking-[0.28em] text-slate-500">City Dossier</p>
      ...
      <section className="grid gap-4 xl:grid-cols-[1fr_1fr]">
        <div className="aurora-panel rounded-[30px] border border-white/10 p-6">
          <p className="text-[10px] uppercase tracking-[0.28em] text-slate-500">Macro Stats</p>
        ...
        <div className="aurora-panel rounded-[30px] border border-white/10 p-6">
          <p className="text-[10px] uppercase tracking-[0.28em] text-slate-500">Systems Health Overview</p>
          <div className="mt-5">
